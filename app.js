...
function createDirectoryFinal() {
    ...
    var engineerString = ``;
    for (j=0;i<engineerCards.length;j++) {
    ...
    for (k=0;k<internCards.length;k++) {
        engineerString += `<div class="card" style="width: 18rem;"><div class="card-body"><h5 class="card-title">Intern</h5><h6 class="card-subtitle mb-2 text-muted"> Name: ${internCards[k].name} </h6><p>Employee ID: ${internCards[k].id}</p><p>E-mail: ${internCards[k].email}</p><p>School: ${internCards[k].school}</p>`;
    };
